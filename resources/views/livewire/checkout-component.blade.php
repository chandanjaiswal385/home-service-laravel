            ...
            <div class="wrap-address-billing">
              ...
              <div class="billing-address">
                ...
                <p class="row-in-form">
                  ...
                  <input  type="number" name="zip-code" value="" placeholder="Your Pin  code" wire:model="zipcode">
                ...
                <p class="row-in-form fill-wife">
                  ...
                  <label class="checkbox-field">
                    ...
                    <span>service at different address?</span>
                  </label>
                </p>
            </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="wrap-address-billing">
                  ...
                  <div class="billing-address">
                    ...
                    <p class="row-in-form">
                      <label for="zip-code">Pin Code:</label>
                      <input  type="number" name="zip-code" value="" placeholder="Your Pin  code" wire:model="s_zipcode">
          ...
          <div class="summary-item payment-method">
            ...
            <div class="choose-payment-methods">
              <label class="payment-method">
                ...
                <span class="payment-desc">Service Now Pay on Delivery</span>
              </label>
              <label class="payment-method">
              ...
              <label class="payment-method">
                ...
                <span class="payment-desc">Now You can Pay with UPI also</span>
              </label>
              @error('paymentmode') <span class="text-danger">{{$message}}</span> @enderror
            </div>

            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">₹{{Cart::instance('cart')->subtotal()}}</span></p>

            <button type="submit" class="btn btn-medium">Book Service now</button>
          </div>
