...
<head>
    <meta charset="utf-8">
    <title>Homeservice - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+916205217175"><i class="fa fa-phone"></i>  6205217175</a></li>
                            <li><a href=" mailto:contact@homeservice.in"><i class="fa fa-envelope"></i>
                                     contact@homeservice.in</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+916205217175"><i class="fa fa-phone"></i>
                                     6205217175</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i>  LNJPIT, Chapra</a></li>
                        </ul>
                    </div>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#">  LNJPIT, Chapra, India</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href=" mailto:contact@homeservice.in"> contact@homeservice.in</a>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890"> 6205217175</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+916205217175"> 6205217175</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2022 HomeService. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
